...
import { MdAdd, MdContactPage, MdDelete, MdEdit, MdOutlineShoppingCart } from "react-icons/md";
        ...
        <ProtectedRoute>
            <div className="flex min-h-screen bg-[var(--sunshine)]">
                ...
                <main className="flex-1 ml-0 p-6">
                    <h1 className="text-5xl text-[var(--mulberry)] font-semibold mb-6">Hóspedes</h1>
                    ...
                    <div>
                        <div className="flex gap-2 mb-6">
                            <input
                                ...
                                className="bg-gray-100 border-1 border-[var(--mulberry)]/50 rounded-lg py-2 px-4 w-full"
                            />

                            <button
                                onClick={() => setIsAddModalOpen(true)}
                                className="bg-[var(--mulberry)] text-[var(--sunshine)] px-4 rounded-lg flex items-center justify-center hover:bg-[var(--mulberry)]/90 transition-colors cursor-pointer"
                            >
                    ...
                    {hospedes.length === 0 ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                            {hospedes.map((hospede) => (
                                <div
                                    key={hospede.id}
                                    className="bg-gray-100 shadow-lg rounded-xl p-6 pt-4 flex flex-col justify-between border-t-4 border-[var(--mulberry)]"
                                >
                                    <div>
                                        <div className="flex justify-between items-center p-2 bg-[var(--sunshine)]/20 rounded-2xl border-1 border-[var(--mulberry)]/20">
                                            <h2 className="text-xl text-[var(--mulberry)] font-semibold mb-2 truncate">{hospede.nome}</h2>
                                            <div className="flex justify-between items-center gap-2">
                                                <button
                                                    ...
                                                    className="w-full bg-[var(--sunshine)]/60 hover:bg-[var(--sunshine)] text-[var(--mulberry)] py-3 px-3 rounded-lg transition-colors cursor-pointer"
                                                >
                                                    <MdEdit />
                                                </button>
                                        ...
                                        <div className="flex flex-col space-y-3 mt-2">
                                            <div className="flex bg-[var(--sunshine)]/20 p-2 items-center gap-4 rounded-2xl border-1 border-[var(--mulberry)]/20">
                                                <MdContactPage className="text-5xl p-2 bg-[var(--sunshine)]/50 rounded-2xl border-1 border-[var(--mulberry)]/20" />
                                            ...
                                            <div className="flex bg-[var(--sunshine)]/20 p-2 items-center gap-4 rounded-2xl border-1 border-[var(--mulberry)]/20">
                                                <FaInfo className="text-5xl p-2 bg-[var(--sunshine)]/50 rounded-2xl border-1 border-[var(--mulberry)]/20" />
                                                <div className="flex flex-col">
                                                    <h2>Informações</h2>
                                            ...
                                            <div className="flex bg-[var(--sunshine)]/20 p-2 items-center gap-4 rounded-2xl border-1 border-[var(--mulberry)]/20">
                                                <FaMapLocationDot className="text-5xl p-2 bg-[var(--sunshine)]/50 rounded-2xl border-1 border-[var(--mulberry)]/20" />
                                                <div className="flex flex-col">
                                                    <h2>Endereço</h2>
